...
import { registerService, clearErrors } from 'redux/actions/Services'
import { APP_PREFIX_PATH } from 'configs/AppConfig';
import { CREATE_SERVICE_RESET } from 'redux/constants/Services';

export default function Form() {
  let history = useHistory();
  const dispatch = useDispatch();

  const { service, error, loading } = useSelector(state => state.registerService);
  ...
  }, [dispatch, error, service, history])

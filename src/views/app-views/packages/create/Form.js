...
export default function Form() {
  ...
  const [ticketsMaxNum, setTicketsMaxNum] = useState('')
  const [compoundsMaxNum, setCompoundsMaxNum] = useState('')
  const [supervisorsMaxNum, setSupervisorsMaxNum] = useState('')
  const [tenantsMaxNum, setTenantsMaxNum] = useState('')
  const [laborsMaxNum, setLaborsMaxNum] = useState('')

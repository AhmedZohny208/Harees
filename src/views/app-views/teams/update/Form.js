...
export default function Form() {
  ...
  const [description, setDescription] = useState('structural timberwork in framing and items such as doors, windows, and staircases')
  const [teamLead, setTeamLead] = useState('Asif Khan')

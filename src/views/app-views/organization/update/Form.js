...
export default function Form() {
  ...
  const [mobNumber, setMobNumber] = useState('233325255')
  const [contractStartDate, setContractStartDate] = useState(moment('2022/01/10', dateFormat))
  const [isActive, setIsActive] = useState(true)
  const [inputValues, setInputValues] = useState({
    organizationName: 'EMAAR',
    represetitiveName: 'Ahmed Ali',
    represetitivePosition: 'CEO',
    email: 'a.ali@emaar.com',
    username: 'Ahmed Ali',
  })
          ...
          <Row justify="space-between" align="bottom">
            <Col span={6}>
              <div className="input is-active">
                ...
                <Switch defaultChecked={isActive && true} onChange={onIsActive} />
              </div>
            </Col>
            <Col span={6}>

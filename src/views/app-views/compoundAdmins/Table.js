...
export default function TableC() {
    ...
    },
    {
      ...
      render: (text, record) => (
        <Space>
          ...
          <EditOutlined className='edit-btn' onClick={() => history.push(`${APP_PREFIX_PATH}/home/compound-admins/update/${record.id}`)} />
  ...
  return (
    ...
    <Card
      ...
      extra={<CreateBtn text='Create a new compound admin' onclick={() => history.push(`${APP_PREFIX_PATH}/home/compound-admins/create`)} />}
    >
      <Table
        columns={columns}
        dataSource={data}
